...
class StarterSite extends TimberSite
{
    ...
    public function spm_acf_show_admin($show)
    {
...
// BOT PROTECTION: Cap posts_per_page to prevent runaway crawler queries.
// Bots (notably GPTBot) follow incrementing posts_per_page pagination links
// generated by The Events Calendar, causing massive DB queries. This filter
// silently caps any value over 100 to a safe maximum.
add_filter('request', function ($vars) {
    if (isset($vars['posts_per_page']) && (int) $vars['posts_per_page'] > 100) {
